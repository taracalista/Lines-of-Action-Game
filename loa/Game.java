...
class Game {
    ...
    private boolean processCommand(String line) {
        ...
        if (command.matches()) {
            ...
            case "quit":
                ...
                return true;
            case "set":
                String cr = command.group(2).toLowerCase();
                int n1 = cr.charAt(0) - 'a' + 1;
                int n2 = cr.charAt(1) - '0';
                String p = command.group(3).toLowerCase();
                Piece p1 = setValueOf(p);
                _board.set(n1, n2, p1, p1.opposite());
                return true;
            case "dump":
    ...
    private void announceWinner() {
        if (_board.piecesContiguous(BP) && _board.piecesContiguous(WP)) {
            System.out.println(_board.turn().fullName() + " wins.");
